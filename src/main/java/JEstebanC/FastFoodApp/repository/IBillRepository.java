...
public interface IBillRepository extends JpaRepository<Bill, Long> {
	...
	@Query(value = "SELECT * FROM bill WHERE id_user=:idUser AND status_bill=:statusBill AND date BETWEEN :startDate AND :endDate", nativeQuery = true)
	...
	@Query(value = "SELECT * FROM bill WHERE id_user=:idUser", nativeQuery = true)
	...
	@Query(value = "SELECT * FROM bill WHERE id_user=:idUser AND status_bill=:statusBill", nativeQuery = true)
	Collection<Bill> findByIdUserAndStatusBill(@Param("idUser") Long idUser, @Param("statusBill") int statusBill);

	@Query(value = "SELECT * FROM bill WHERE id_user=:idUser AND date BETWEEN :startDate AND :endDate", nativeQuery = true)
